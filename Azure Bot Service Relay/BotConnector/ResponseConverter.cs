...
namespace GenericRelayBot.BotConnectorApp
{
    ...
    {
        /// <summary>
        /// Convert single DirectLine activity into IMessageActivity instance. Convert format of response from Copilot Studio (Direct Line) to what is sent to Bot Service user
